<template>
  <div class="g-container">
    <el-scrollbar style="height:100%">
      <el-card shadow="never" class="m-search">
        ...
        <div style="text-align: right;">
          ...
          <DisplayFields ref="searchField" title="更多查询字段" left-icon="el-icon-s-operation" api-name="teacher_query" @GetUserDisplay="getCondition" />
      ...
      <el-card style="margin-top:15px" shadow="never">
        <el-form ref="form" :inline="true">
          ...
          <div class="mb15">
            ...
            <DisplayFields title="更多表格字段" api-name="teacher_display" show-sort left-icon="el-icon-s-operation" @GetUserDisplay="getMoreInfo" />
          </div>
        </el-form>
        <div>
    ...
    <!-- 新增弹框 -->
    <modifyDialog v-model="modifyVisible" :add-sign="addSign" :form="form" :template-info="templateInfo" :data="dictObject" @getList="QueryTeacher" />
    <!-- 详情弹框 -->
...
import { QueryTeacher, DelTeacher } from '@/api/UserInfo'
    ...
    getCondition(data) {
      ...
      */
      ...
      const selectArr = [
        ...
        { key: 'TeacherInfo.TeaSatus', name: '教师状态', list: 'JZGDQZT' },
        {
        ...
        { key: 'TeacherInfo.TeaCategory', name: '教师类别', list: 'JZGLB' },
        { key: 'UserDetails.NativePlace', name: '籍贯', list: 'NATIVEPLACE' }
      ]
      // 时间类型
      const selectDate = [{ key: 'UserDetails.Birthday', name: '生日' }]

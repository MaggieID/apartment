<template>
  <div>
    <el-dialog title="确认入住信息" append-to-body :visible.sync="value" width="1200px" :before-close="close">
      <div style="display: flex;">
        ...
        <el-card class="el-card is-always-shadow" style="flex: 1;">
          <userDetail :active-name="activeName" :user-details="userInfo" type="" :bed="bedInfo" :show-contract="false" style="margin-top: -10px;"></userDetail>
        </el-card>
          ...
          <div style="height:calc(100% - 50px);" class="m-search">
            <el-scrollbar style="height:100%">
              <el-form ref="form" :model="form" :rules="rules" label-width="120px">
                ...
                <div style="font-weight: bold;margin-bottom: 15px;">入住规则</div>
...
<script>
import { ExcelBatchRZ } from '@/api/LiveOperation'
    ...
    RuZhuSubmit() {
      var tishi =
        this.dataList.length > 1
          ? `你确定要批量安排这${this.dataList.length}个人入住吗?`
          : `你确认要继续安排${this.dataList[this.user].UserName}入住该床位吗?`

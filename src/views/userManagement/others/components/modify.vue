            ...
            <div style="height:460px">
              <el-scrollbar style="height:100%">
                <el-row :gutter="20">
                  ...
                  <el-col :span="8">
                    <el-form-item label="用户编码" prop="Number">
                  ...
                  <el-col :span="8">
                    <el-form-item label="身份" prop="Identity">
                      <el-select v-model="form.Identity" placeholder="请选择">
                        <el-option :value="30">临时人员</el-option>
                        <el-option :value="31">社会人员</el-option>
                      </el-select>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
...
import { RegisterOtherStaffs, UpdateOtherStaffsInfo } from '@/api/UserInfo'

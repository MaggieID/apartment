<template>
  <div>
    <el-dialog :visible.sync="value" title="学生详情" :before-close="cancel" :modal="false" width="1000px">
              ...
              <el-scrollbar style="height:100%">
                <div style="display: flex;">
                  <el-row>
                    ...
                    <el-col :span="12">
                      <el-form-item label="学号："> {{ data.Number }} </el-form-item>
                    </el-col>
                    <el-col :span="12">
                      <el-form-item label="性别："> {{ data.Sex_CN }} </el-form-item>
                    </el-col>
                    <el-col :span="12">
                      <el-form-item label="入学时间："> {{ data.StartSchoolTime }} </el-form-item>
                    </el-col>
                    <el-col :span="12">
                      <el-form-item label="学制："> {{ data.StudyingYear_CN }} </el-form-item>
                    </el-col>
                    <el-col :span="12">
                      <el-form-item label="学生状态："> {{ data.StuSatus_CN }} </el-form-item>
                    </el-col>
                    <el-col :span="12">
                      <el-form-item label="学生类别："> {{ data.StuCategory_CN }} </el-form-item>
                    </el-col>
                    <el-col :span="12">
            ...
            <div class="detailsinfo">
              <el-scrollbar style="height:100%">
                <div>
                  ...
                  <span>
                    <el-tag v-if="data.IsCheckIn==1" type="success">是</el-tag>
                    <el-tag v-if="data.IsCheckIn==0" type="danger">否</el-tag>
                  </span>
                </div>
                <div>
            ...
            <div class="detailsinfo">
              <el-scrollbar style="height:100%">
                <el-row>
                  ...
                  <!-- <el-col :span="8">
                    <el-form-item label="密码："> {{ data.StuCategory_CN }} </el-form-item>
                  </el-col> -->
                  <el-col :span="8">
